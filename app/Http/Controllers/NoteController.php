...
class NoteController extends Controller
{
    ...
    public function savePoint(Request $request)
    {
       ...
       //ثبت امتیاز برای یادداشت نویس
       switch ($miyangin) {
           case $miyangin >17:
           //ثبت امتیاز برای یادداشت نویس
               $this->saveUserPoint(+20,'دریافت نشان طلایی برای یادداشت',$note->user_id);
               //ثبت در تاریخچه یادداشت
               $this->addToNoteHistory($note->id,'یادداشت ارزیابی شد و نشان طلایی گرفت','ارزیابی');
           ...
           case ($miyangin >14 && $miyangin<17):
           //ثبت امتیاز برای یادداشت نویس

           $this->saveUserPoint(+15,'دریافت نشان نقره ای برای یادداشت',$note->user_id); 
           //ثبت در تاریخچه یادداشت
          ...
          $this->sendMessage('یادداشت شما ارزیابی شد','یادداشت شما ارزیابی شد و نشان نقره ای گرفت',0,$note->user_id);
           ...
           //ثبت امتیاز برای یادداشت نویس
           $this->saveUserPoint(+10,'دریافت نشان برنزی برای یادداشت',$note->user_id); 
           //ثبت در تاریخچه یادداشت
       ...
       ################################################################################
       ################################################################################
        return redirect('notes')->with('message','ارزیابی انجام شد.');
    }
